...
public class Cust {
    ...
    public Cust(int custId, String custName, String respPerson, String custMobNo, String custEmail, String custAddress, String custPanNo, String custGstNo, int custType, int delStatus, int plantId, String dateOfReg) {
        this.custId = custId;
